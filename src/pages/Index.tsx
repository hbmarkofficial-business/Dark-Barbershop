  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Dark Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Dark Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Dark Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Dark Barbershop | Premium Barbershop Berlin" />
        <meta
